...
image=ImageTk.PhotoImage(Image.open(path+"/image.png"))
canvas.create_image(0,0, anchor=NW, image=image)


#instructions
instructions= Label(root, text="Select the file to be sorted", font="Calibri 25 bold", fg="#ffffff", bg="#121212")
...
browse_btn= Button(root, textvariable=browse_text, command=lambda:open_file(), font="Calibri 8 bold", width=50, height=3, bg="#ff8045", fg="white")
browse_text.set("Browse file")
browse_btn.grid(column=1, row=1, pady=100)
